...
export const ENDPOINT_ETHEREUM_BRIDGE = 'https://btc-wbtc-mainnet.quantexe.com/api/v1';
export const ENDPOINT_BSC_BRIDGE = 'https://btc-bsc-mainnet.quantexe.com/api/v1';
