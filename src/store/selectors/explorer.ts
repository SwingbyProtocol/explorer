...
import { ExplorerState, NetworkInfo, NetworkStats, NodeEndpoint, USDPrices } from '../types';
...
// @todo (agustin) add redux toolkit and use createSelector with usdPricesSelector
export const swingbyUSDPriceSelector = (state: DefaultRootState): number => state.explorer.usd.BTC;
